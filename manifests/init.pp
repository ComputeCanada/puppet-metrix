class metrix (
  ...
  Array[Hash[String, String]] $saml2_staff_attributes = [],
  Array[Hash[String, String]] $saml2_required_access_attributes = [],
    ...
    content   => epp('metrix/99-local.py',
      {
        ...
        'saml2_staff_attributes'           => $saml2_staff_attributes,
        'saml2_required_access_attributes' => $saml2_required_access_attributes,
      }
    ),
    owner     => 'apache',
    group     => 'apache',
